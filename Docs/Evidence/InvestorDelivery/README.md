...
12. `18_english_person_profile_window_2026-08-16.jpg`：包含 Slate UI 的真实 UE 窗口截图，证明人物姓名、职业、性别年龄、应用、位置、服务节点和信号质量均为英文。
13. `investor_profile_english_runtime_2026-08-16.json`：100 个人物档案全量语言验收；100 个英文姓名唯一，中文字符违规数为 0。
