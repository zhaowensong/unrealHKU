...
> [!warning] 2026-08-12 已取消运行时 HISM 替换
> 本文记录的“9 个 HISM 批次”是历史实现。当前人物启动不再隐藏或批处理原信道，编辑器态和 PIE 直接显示同一批 1950 个持久化 Actor。最终实现见 [[TelecomTwin_启动前后建筑信道完全一致_2026-08-12]]。
